...
const CampaignForm: React.FC<ConfigurateCampaignFormProps> = ({
    ...
    const { loading: loadingSaveCampaignDetails, error: saveCampaignDetailsError, saveCampaignDetails } = useSaveCampaignDetails();
    ...
    const onSubmit = (data: FormValues, actionType: "save" | "activate") => {
        const dataToActivateCampaign = {
            ...
            event_phone_number: campaignData?.phoneNumber || '',
            ...
            exhibitor_contact_phone: data.exhibitorPhone || campaignData?.exhibitorContactNumber || "",
        };
        ...
        const dataToSaveCampaign = {
            ...
            exhibitor_description: data.exhibitorDescription || campaignData?.exhibitorDescription || "",
            exhibitor_contact_name: data.exhibitorContactName || campaignData?.exhibitorContactName || "",
            exhibitor_contact_number: data.exhibitorPhone || campaignData?.exhibitorContactNumber || "",
    ...
    return (
        <S.FormContainer onSubmit={(e) => e.preventDefault()}>
            ...
            <S.Footer>
                <Button
                    disabled={!isFormValid || loadingSaveCampaignDetails}
                    type="button"
