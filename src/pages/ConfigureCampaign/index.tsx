...
const ConfigureCampaign: React.FC = () => {
    ...
    const { data: campaignDetails, fetchCampaignDetails, loading: loadingCampaignDetails } = useCampaignDetails();
    ...
    useEffect(() => {
        if (campaignContentId && registeredEventId) {
            fetchCampaignDetails(registeredEventId, campaignContentId);
        }
    }, [campaignContentId, registeredEventId]);
        ...
        <div>
            ...
            <S.Section>
                ...
                <S.GridContainer>
                    ...
                    <S.InfoBox>
                        <span>Expositor:</span>
                        <p>{campaignData.exhibitorName}</p>
                    </S.InfoBox>
                    <S.InfoBox>
                        <span>Template:</span>
                        <p>{campaignData.templateName}</p>
                    </S.InfoBox>
                </S.GridContainer>
                ...
                <S.GridContainer>
                    <S.InfoBox>
                        <span>Telefone:</span>
                        <p>{campaignData.phoneName}</p>
                        <p>{campaignData.phoneNumber}</p>
                    </S.InfoBox>
                    <S.InfoBox>
                        <span>Quantidade de disparos:</span>
                        <p>{campaignData.leadsReached}</p>
                        <p>por expositor</p>
                    </S.InfoBox>
                    <S.InfoBox>
                        <span>Data e Hora:</span>
                        <p>{campaignData.campaignDate}</p>
                        <p>{campaignData.campaignTime}h</p>
                    </S.InfoBox>
                </S.GridContainer>
            </S.Section >

            <S.SpaceY32 />
            <ConfigurateCampaignForm selectedEngine={selectedEngine} campaignData={campaignData}>
