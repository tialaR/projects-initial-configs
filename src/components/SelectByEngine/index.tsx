...
const ENGINE_OPTIONS: EngineOption[] = [
    { id: "engine-class", label: "Class", status: "TBD", statusColor: "positive100" },
    { id: "engine-cluster", label: "Cluster", status: "TBD", statusColor: "info100" },
    { id: "engine-recommendation", label: "Recommendation", status: "TBD", statusColor: "warning100" }
];
