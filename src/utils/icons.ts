...
import GeneralCampaign from "../assets/svg/general-campaign.svg?react";
import ExhibitorCampaign from "../assets/svg/exhibitor-campaign.svg?react";
...
import CheckSuccess from "../assets/svg/check-success.svg?react";
import Chronic from "../assets/svg/chronic.svg?react";
import ArrowDrawer from "../assets/svg/arrow-drawer.svg?react";

export const iconMap = {
    whatsapp: Whatsapp,
    generalCampaign: GeneralCampaign,
    exhibitorCampaign: ExhibitorCampaign,
